    ...
    return (
          ...
          <div className="App">
              ...
              <div className={"centerDiv"}>
                  <div className={"logo"} onClick={()=>{window.location.href = backToMainPage()}} >
                      SimpleURL
                  </div>
              </div>
              {statusNavBarWidget(false)}
              {divider()}
              <br/><br/><br/>
...
export function checkError(validURL, inputURL){
    if(validURL){
        return false;
    } else if(inputURL === ""){
        return false;
...
export function returnErrorMessage(validURL, inputURL){
...
export function disableButton(validURL, inputURL){
    if(validURL && inputURL){
        return false;
    } else{
        return true;
